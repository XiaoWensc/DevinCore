package stroe.devin.com.devinandroiddemo.widget.webview;
...
public class UIWebView extends WebView {
    ...
    public UIWebView(Context context, AttributeSet attrs, int defStyle, boolean isShowProgress) {
        ...
        syncCookie(context, Uri.parse(App.getInstance().setBaseUrl()).getHost());
...
//        settings.setUserAgentString("android");
        ...
        if (NetUtils.isConnected(CoreApp.getAppContext())) { //判断是否联网
